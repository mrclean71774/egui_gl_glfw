...
impl std::default::Default for UserTexture {
    fn default() -> Self {
        Self {
            size: Default::default(),
            pixels: Default::default(),
            gl_texture_id: Default::default(),
...
impl Painter {
    ...
    pub fn new(window: &mut glfw::Window) -> Painter {
        let vs_source = std::fs::read_to_string("src/shader/vertex.vert").unwrap();
        let fs_source = std::fs::read_to_string("src/shader/fragment.frag").unwrap();
